        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Services", "Work", "About", "Contact"].map(item => <li key={item}>
                  <a href={`#${item.toLowerCase()}`} className="font-body text-muted-foreground hover:text-foreground transition-colors">
                    {item}
                  </a>
                </li>)}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["UI/UX Design", "Web Development", "Brand Identity", "Digital Strategy"].map(item => <li key={item}>
